 ...
 */
@Component({
  selector: 'app-numerical-serie-easy',
  templateUrl: './numerical-serie-easy.component.html',
  styleUrls: ['./numerical-serie-easy.component.css']
})
export class NumericalSerieEasyGame extends GameTemplate implements OnInit {
  serie: Element[] = [];
  answer: Element[] = [];
  options: Element[] = [];
  offset: number;
