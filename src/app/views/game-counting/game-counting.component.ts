...
@Component({
  ...
  templateUrl: './game-counting.component.html',
  styleUrls: ['./game-counting.component.css']
})
export class GameCountingComponent implements OnInit {
  games: Game[] = [];
  current = 0;
  user: User;
