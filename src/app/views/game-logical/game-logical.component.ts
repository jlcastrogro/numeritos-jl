...
@Component({
  selector: 'app-game-logical',
  templateUrl: './game-logical.component.html',
  styleUrls: ['./game-logical.component.css']
})
export class GameLogicalComponent implements OnInit {
  games: Game[] = [];
  current = 0;
  user: User;
