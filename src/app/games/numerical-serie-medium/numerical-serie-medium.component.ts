 ...
 */
@Component({
  selector: 'app-numerical-serie-medium',
  templateUrl: './numerical-serie-medium.component.html',
  styleUrls: ['./numerical-serie-medium.component.css']
})
export class NumericalSerieMediumGame extends GameTemplate implements OnInit {
  serie: Element[] = [];
  answer: Element[] = [];
  options: Element[] = [];
  offset: number;
  ...
  ngOnInit() {
    ...
    this.options.push({
      id: this.serie.length,
      value: this.offset + this.serie.length
    });
